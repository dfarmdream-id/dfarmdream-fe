...
import { useUpdateDocumentInvestment } from "@/app/(authenticated)/_services/document-investment";
...
export default function Page() {
  ...
  const submission = useUpdateDocumentInvestment();
    ...
    submission.mutate(
      {
        ...
        pathVars: {
          id: params.investmentId as string,
        },
      },
      {
        onError: (error) => {
  ...
  return (
    <div className="p-5">
      <div className="text-2xl font-bold mb-10">Edit Dokumen Investasi</div>
      <div>
