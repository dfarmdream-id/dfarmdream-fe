import {
  ...
  import { useDeletePersediaanBarang } from "@/app/(authenticated)/_services/persediaan-barang";
  ...
  export default function Actions(props: Props) {
    ...
    const deleteData = useDeletePersediaanBarang();
      ...
      <div className="flex space-x-1">
        <Can action="update:cash-flow-category">
          <Tooltip content="Edit Data">
            <Button
              as={Link}
              href={`/stock/persediaan-barang/${props.id}/edit`}
              isIconOnly
              variant="light"
              color="primary"
            >
