...
export default function Page() {
  ...
  const user = useGetListKategoriBiaya(
    useMemo(
  ...
  return (
    <div className="p-5">
      <div className="text-3xl font-bold mb-10">Data Kategori Biaya</div>
      <div className="space-y-5 bg-white p-5 rounded-lg">
        <div className="flex justify-between items-center gap-3 flex-wrap">
          ...
          <Button
            as={Link}
            href="/cash/kategori-biaya/create"
            color="primary"
            startContent={<HiPlus />}
