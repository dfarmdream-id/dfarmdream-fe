...
import { useGetListJournalType } from "../../_services/journal-type";

const columns = [
  {
    key: "code",
    label: "ID Tipe Jurnal",
  },
  {
    key: "name",
    label: "Nama Template Jurnal",
  },
  {
    key: "createdAt",
...
export default function Page() {
  ...
  const user = useGetListJournalType(
    useMemo(
  ...
  return (
    <div className="p-5">
      <div className="text-3xl font-bold mb-10">Journal Type Data</div>
