...
import { useDeleteJournalType } from "@/app/(authenticated)/_services/journal-type";
  ...
  export default function Actions(props: Props) {
    ...
    const deleteData = useDeleteJournalType();
      ...
      <div className="flex space-x-1">
        <Can action="update:cash-flow-category">
          <Tooltip content="Edit Data">
            <Button
              as={Link}
              href={`/cash/journal-type/${props.id}/edit`}
              isIconOnly
              variant="light"
              color="primary"
            >
