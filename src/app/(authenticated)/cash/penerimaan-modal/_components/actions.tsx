...
import { useDeletePenerimaanModal } from "@/app/(authenticated)/_services/penerimaan-modal";
  ...
  export default function Actions(props: Props) {
    ...
    const deleteData = useDeletePenerimaanModal();
    ...
    const handleDelete = (id: string) => {
      deleteData.mutate(
        ...
        {
          onSuccess: () => {
            toast.success("Berhasil menghapus data penerimaan-modal");
            queryClient.invalidateQueries({
              queryKey: ["/v1/penerimaan-modal"],
            });
      ...
      <div className="flex space-x-1">
        <Can action="update:cash-flow-category">
          <Tooltip content="Edit Data">
            <Button
              as={Link}
              href={`/cash/penerimaan-modal/${props.id}/edit`}
              isIconOnly
              variant="light"
              color="primary"
            >
